...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("dad", "Antartivania", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Antartivania";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Antartivania", null, { width: 256, height: 240 });
